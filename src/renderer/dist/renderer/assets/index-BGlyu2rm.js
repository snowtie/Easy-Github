...
function M$2(a, b2, e) {
  ...
  if (null != b2) for (d in void 0 !== b2.ref && (h = b2.ref), void 0 !== b2.key && (k2 = "" + b2.key), b2) J$1.call(b2, d) && !L$1.hasOwnProperty(d) && (c[d] = b2[d]);
...
function R$1(a, b2, e, d, c) {
  ...
  if (h) return h = a, c = c(h), a = "" === d ? "." + Q$1(h, 0) : d, I$2(c) ? (e = "", null != a && (e = a.replace(P$1, "$&/") + "/"), R$1(c, b2, e, "", function(a2) {
    return a2;
  })) : null != c && (O$2(c) && (c = N$2(c, e + (!c.key || h && h.key === c.key ? "" : ("" + c.key).replace(P$1, "$&/") + "/") + a)), b2.push(c)), 1;
  h = 0;
  d = "" === d ? "." : d + ":";
...
react_production_min.cloneElement = function(a, b2, e) {
  ...
  if (null != b2) {
    ...
    for (f2 in b2) J$1.call(b2, f2) && !L$1.hasOwnProperty(f2) && (d[f2] = void 0 === b2[f2] && void 0 !== g ? g[f2] : b2[f2]);
  }
...
function Zh(a, b2) {
  var c = M$1, d = Uh(), e = b2(), f2 = !He(d.memoizedState, e);
...
var M = (e, i, s, u2, m2, a, l2, h) => {
  let d = document.documentElement, w2 = ["light", "dark"];
  function p2(n2) {
    (Array.isArray(e) ? e : [e]).forEach((y2) => {
      let k2 = y2 === "class", S2 = k2 && a ? m2.map((f2) => a[f2] || f2) : m2;
      k2 ? (d.classList.remove(...S2), d.classList.add(a && a[n2] ? a[n2] : n2)) : d.setAttribute(y2, n2);
    }), R2(n2);
  }
  function R2(n2) {
    h && w2.includes(n2) && (d.style.colorScheme = n2);
  }
  function c() {
  ...
  if (u2) p2(u2);
    ...
    let n2 = localStorage.getItem(i) || s, y2 = l2 && n2 === "system" ? c() : n2;
    p2(y2);
  } catch (n2) {
  }
};
var b = ["light", "dark"], I = "(prefers-color-scheme: dark)", O = typeof window == "undefined", x = reactExports.createContext(void 0), U = { setTheme: (e) => {
...
}, J = (e) => reactExports.useContext(x) ? reactExports.createElement(reactExports.Fragment, null, e.children) : reactExports.createElement(V, { ...e }), N = ["light", "dark"], V = ({ forcedTheme: e, disableTransitionOnChange: i = false, enableSystem: s = true, enableColorScheme: u2 = true, storageKey: m2 = "theme", themes: a = N, defaultTheme: l2 = s ? "system" : "light", attribute: h = "data-theme", value: d, children: w2, nonce: p2, scriptProps: R2 }) => {
  let [c, n2] = reactExports.useState(() => H(m2, l2)), [T2, y2] = reactExports.useState(() => c === "system" ? E() : c), k2 = d ? Object.values(d) : a, S2 = reactExports.useCallback((o) => {
    let r2 = o;
    if (!r2) return;
    o === "system" && s && (r2 = E());
    let v2 = d ? d[r2] : r2, C2 = i ? W(p2) : null, P2 = document.documentElement, L2 = (g) => {
      g === "class" ? (P2.classList.remove(...k2), v2 && P2.classList.add(v2)) : g.startsWith("data-") && (v2 ? P2.setAttribute(g, v2) : P2.removeAttribute(g));
    };
    if (Array.isArray(h) ? h.forEach(L2) : L2(h), u2) {
      let g = b.includes(l2) ? l2 : null, D2 = b.includes(r2) ? r2 : g;
  ...
  }, [c]), A2 = reactExports.useCallback((o) => {
    let r2 = E(o);
    y2(r2), c === "system" && s && !e && S2("system");
  }, [c, e]);
  reactExports.useEffect(() => {
    let o = window.matchMedia(I);
    return o.addListener(A2), A2(o), () => o.removeListener(A2);
  ...
  let Q2 = reactExports.useMemo(() => ({ theme: c, setTheme: f2, forcedTheme: e, resolvedTheme: c === "system" ? T2 : c, themes: s ? [...a, "system"] : a, systemTheme: s ? T2 : void 0 }), [c, f2, e, T2, s, a]);
  return reactExports.createElement(x.Provider, { value: Q2 }, reactExports.createElement(_, { forcedTheme: e, storageKey: m2, attribute: h, enableSystem: s, enableColorScheme: u2, defaultTheme: l2, value: d, themes: a, nonce: p2, scriptProps: R2 }), w2);
}, _ = reactExports.memo(({ forcedTheme: e, storageKey: i, attribute: s, enableSystem: u2, enableColorScheme: m2, defaultTheme: a, value: l2, themes: h, nonce: d, scriptProps: w2 }) => {
  let p2 = JSON.stringify([s, i, a, e, h, l2, u2, m2]).slice(1, -1);
...
const CardContent = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: cn$2("p-6 pt-0", className), ...props }));
...
function Badge({ className, variant, ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn$2(badgeVariants({ variant }), className), ...props });
}
/**
...
const Bug = createLucideIcon("bug", __iconNode$A);
/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const CircleHelp = createLucideIcon("circle-help", __iconNode$w);
/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const FileX = createLucideIcon("file-x", __iconNode$m);
/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function ProjectOverview() {
  ...
  const [showAddProject, setShowAddProject] = reactExports.useState(false);
  const [newProjectUrl, setNewProjectUrl] = reactExports.useState("");
  const [newProjectPath, setNewProjectPath] = reactExports.useState("");
  const applyStatusToProject = (projectId, status) => {
    setProjects((prev) => {
      const next = prev.map((p2) => {
        if (p2.id !== projectId) return p2;
        const uncommitted = Number(status?.modified ?? 0) + Number(status?.untracked ?? 0) + Number(status?.deleted ?? 0);
        return {
          ...p2,
          currentBranch: status?.current ?? p2.currentBranch,
          ahead: Number(status?.ahead ?? p2.ahead),
          behind: Number(status?.behind ?? p2.behind),
  ...
  const handleCloneProject = async () => {
    ...
    try {
      ...
      localStorage.setItem("activeProjectPath", newProjectPath);
  ...
  const handleRemoveProject = (id2, name) => {
    setProjects((prev) => {
  ...
  const handleCheckStatus = async (projectId, projectPath) => {
    if (!window.easyGithub) {
  ...
  const handleFetch = async (projectId, projectPath) => {
    if (!window.easyGithub) {
  ...
  const handlePull = async (projectId, projectPath) => {
    if (!window.easyGithub) {
  ...
  const handlePush = async (projectId, projectPath) => {
    if (!window.easyGithub) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "전체 프로젝트" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold mt-1", children: projects.length })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(FolderGit2, { className: "w-10 h-10 text-blue-500" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "변경사항" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold mt-1", children: projects.reduce((sum, p2) => sum + p2.uncommittedChanges, 0) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-10 h-10 text-orange-500" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Push 대기" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold mt-1", children: projects.reduce((sum, p2) => sum + p2.ahead, 0) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "w-10 h-10 text-green-500" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Pull 필요" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold mt-1", children: projects.reduce((sum, p2) => sum + p2.behind, 0) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(GitBranch, { className: "w-10 h-10 text-purple-500" })
      ] }) }) })
    ] }),
    !showAddProject && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-blue-600 p-4 rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-8 h-8 text-white" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-blue-900 dark:text-blue-100", children: "프로젝트 추가하기" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-700 dark:text-blue-200 mt-2", children: "GitHub에서 코드를 다운로드하거나 새 프로젝트를 시작하세요" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "lg", className: "mt-4", children: [
    ...
    showAddProject && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2 border-blue-500 shadow-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "bg-blue-50 dark:bg-blue-950/30", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-5 h-5" }),
          "새 프로젝트 추가"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-base", children: "GitHub 저장소를 Clone(다운로드)하거나 로컬 프로젝트를 추가하세요" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-6 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-yellow-50 border-yellow-200 dark:bg-yellow-950/20 dark:border-yellow-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "💡" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-yellow-900 dark:text-yellow-100", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-1", children: "처음이신가요?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: 'GitHub 저장소 페이지에서 초록색 "Code" 버튼을 누르면 URL을 복사할 수 있어요!' })
          ] })
        ] }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "repo-url", className: "text-base font-semibold", children: "저장소 URL (GitHub 주소)" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "GitHub에서 복사한 저장소 주소를 붙여넣으세요" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "local-path", className: "text-base font-semibold", children: "저장할 폴더 경로" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "local-path",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "컴퓨터에 프로젝트를 저장할 폴더를 입력하세요" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleCloneProject, className: "flex-1", size: "lg", disabled: gitBusy === "clone", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-5 h-5 mr-2" }),
            "프로젝트 다운로드 시작"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setShowAddProject(false), size: "lg", children: "취소" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: "내 프로젝트" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "text-sm", children: [
          projects.length,
          "개"
        ] })
      ] }),
      projects.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-2 border-dashed", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "py-12 text-center text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FolderGit2, { className: "w-16 h-16 mx-auto mb-4 opacity-50" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-semibold", children: "아직 프로젝트가 없어요" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-2", children: '위의 "프로젝트 추가하기" 버튼을 눌러 시작하세요!' })
      ] }) }) : projects.map((project) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "hover:shadow-lg transition-shadow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FolderGit2, { className: "w-6 h-6 text-blue-600" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: project.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-mono", children: project.path })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-blue-100 text-blue-800 border-blue-300", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(GitBranch, { className: "w-3 h-3 mr-1" }),
              project.currentBranch
            ] }),
            project.uncommittedChanges > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "bg-orange-50 text-orange-700 border-orange-300", children: [
              project.uncommittedChanges,
              " 변경됨"
            ] }),
            project.ahead > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "bg-green-50 text-green-700 border-green-300", children: [
              "↑ ",
              project.ahead,
              " 커밋 앞서감"
            ] }),
            project.behind > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "bg-red-50 text-red-700 border-red-300", children: [
              "↓ ",
              project.behind,
              " 커밋 뒤처짐"
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: project.lastCommit })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: project.stars })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "w-4 h-4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: project.collaborators })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                size: "sm",
                variant: "default",
                onClick: () => handleCheckStatus(project.id, project.path),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                size: "sm",
                variant: "outline",
                onClick: () => handleFetch(project.id, project.path),
                disabled: gitBusy === project.id || gitBusy === "clone",
                children: "Fetch"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                size: "sm",
                variant: "outline",
                onClick: () => handlePull(project.id, project.path),
                disabled: gitBusy === project.id || gitBusy === "clone",
                children: "Pull"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                size: "sm",
                variant: "outline",
                onClick: () => handlePush(project.id, project.path),
                disabled: gitBusy === project.id || gitBusy === "clone",
                children: "Push"
              }
            ),
...
const AvatarImage = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  ...
  {
    ref,
    className: cn$2("aspect-square h-full w-full", className),
    ...props
  }
));
...
const ACTIVE_PROJECT_PATH_KEY$5 = "activeProjectPath";
const ACTIVE_PROJECT_NAME_KEY$2 = "activeProjectName";
function CommitHistory() {
  ...
  const [activeProjectPath, setActiveProjectPath] = reactExports.useState(() => localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$5) || "");
  const [activeProjectName, setActiveProjectName] = reactExports.useState(() => localStorage.getItem(ACTIVE_PROJECT_NAME_KEY$2) || "");
  ...
  const getInitials2 = (name) => {
    ...
    return parts.slice(0, 2).map((p2) => p2[0]?.toUpperCase() ?? "").join("");
  };
  const refresh = async () => {
    if (!window.easyGithub) {
    ...
    const repoPath = localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$5) || "";
    const repoName = localStorage.getItem(ACTIVE_PROJECT_NAME_KEY$2) || "";
    ...
    try {
      ...
      const normalized = items.map((c) => {
        ...
        return {
          ...
          message: c.message,
          description: c.body || void 0,
          author,
          authorInitials: getInitials2(author),
  ...
  reactExports.useEffect(() => {
    ...
    const interval = setInterval(() => {
      const nextPath = localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$5) || "";
      if (nextPath && nextPath !== activeProjectPath) {
        refresh();
      }
    }, 1e3);
    return () => clearInterval(interval);
  }, []);
  const filteredCommits = reactExports.useMemo(() => {
    return commits.filter((commit) => {
      const matchesSearch = commit.message.toLowerCase().includes(searchQuery.toLowerCase()) || commit.author.toLowerCase().includes(searchQuery.toLowerCase()) || commit.hash.includes(searchQuery.toLowerCase());
  ...
  const branches = reactExports.useMemo(() => {
    return ["all", ...Array.from(new Set(commits.map((c) => c.branch).filter(Boolean)))];
  }, [commits]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    showGuide && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2 border-purple-500 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/30 dark:to-purple-900/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-purple-900 dark:text-purple-100 flex items-center gap-2", children: "📖 커밋 히스토리란?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: "ghost",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3 text-purple-900 dark:text-purple-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "프로젝트의 타임라인이에요!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "• ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "누가" }),
            " 코드를 바꿨는지"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "• ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "언제" }),
            " 바꿨는지"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "• ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "무엇을" }),
            " 바꿨는지"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "• ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "왜" }),
            " 바꿨는지 (커밋 메시지)"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card/60 p-3 rounded-lg mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", children: [
          "💡 ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "활용법:" }),
          " 버그가 언제 생겼는지 찾거나, 팀원들의 작업을 확인하거나, 이전 버전으로 되돌릴 때 사용해요!"
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "커밋 히스토리" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardDescription, { children: [
          activeProjectName ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "현재 프로젝트: ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: activeProjectName })
          ] }) : "현재 프로젝트가 선택되지 않았습니다",
          activeProjectPath ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs font-mono mt-1", children: activeProjectPath }) : null
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground/70" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: refresh, disabled: busy, children: "새로고침" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: branches.map((branch) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Badge,
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-blue-600", children: filteredCommits.length }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "총 커밋" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "추가된 줄" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-3xl font-bold text-red-600", children: [
          "-",
          filteredCommits.reduce((sum, c) => sum + c.deletions, 0)
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "삭제된 줄" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-purple-600", children: filteredCommits.reduce((sum, c) => sum + c.filesChanged, 0) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "변경된 파일" })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: !activeProjectPath ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "py-12 text-center text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(GitCommitHorizontal, { className: "w-16 h-16 mx-auto mb-4 opacity-50" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "현재 프로젝트가 선택되지 않았어요" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-2", children: '"프로젝트" 탭에서 Clone 후 상태 버튼을 눌러 선택해주세요.' })
    ] }) }) : filteredCommits.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "py-12 text-center text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(GitCommitHorizontal, { className: "w-16 h-16 mx-auto mb-4 opacity-50" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "검색 결과가 없습니다" })
    ] }) }) : filteredCommits.map((commit, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "hover:shadow-md transition-shadow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GitCommitHorizontal, { className: "w-5 h-5 text-blue-600" }) }),
        index < filteredCommits.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-0.5 flex-1 bg-border my-2" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-between gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: getCommitTypeColor(commit.message), children: commit.message }),
            commit.branch && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "font-mono text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(GitBranch, { className: "w-3 h-3 mr-1" }),
              commit.branch
            ] })
          ] }),
          commit.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-2", children: commit.description })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-6 h-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "text-xs", children: commit.authorInitials }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: commit.author }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground/70", children: "•" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: commit.date })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-2 border-t", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { className: "w-4 h-4 text-muted-foreground/70" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                commit.hash,
                /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-3 h-3 ml-2" })
              ]
            }
          ) })
        ] })
...
const ACTIVE_PROJECT_PATH_KEY$4 = "activeProjectPath";
const ACTIVE_PROJECT_NAME_KEY$1 = "activeProjectName";
function BranchManager() {
  const [branches, setBranches] = reactExports.useState([]);
  const [showCreateBranch, setShowCreateBranch] = reactExports.useState(false);
  const [newBranchName, setNewBranchName] = reactExports.useState("");
  const [baseBranch, setBaseBranch] = reactExports.useState("main");
  const [showGuide, setShowGuide] = reactExports.useState(true);
  const [activeProjectPath, setActiveProjectPath] = reactExports.useState(() => localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$4) || "");
  const [activeProjectName, setActiveProjectName] = reactExports.useState(() => localStorage.getItem(ACTIVE_PROJECT_NAME_KEY$1) || "");
  const [busy, setBusy] = reactExports.useState(false);
  const currentBranch = reactExports.useMemo(() => branches.find((b2) => b2.current), [branches]);
  const refresh = async () => {
    if (!window.easyGithub) {
      toast.error("Electron 환경에서만 브랜치 관리를 지원합니다");
      return;
    }
    const repoPath = localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$4) || "";
    const repoName = localStorage.getItem(ACTIVE_PROJECT_NAME_KEY$1) || "";
    setActiveProjectPath(repoPath);
    setActiveProjectName(repoName);
    if (!repoPath) {
      setBranches([]);
    ...
    try {
      ...
      const normalized = all.map((b2) => ({
        id: b2.name,
        name: b2.name,
        current: Boolean(b2.current),
        lastCommit: "",
        author: "",
        ahead: 0,
        behind: 0,
        isProtected: Boolean(b2.protected)
      }));
      setBranches(normalized);
      const current = normalized.find((b2) => b2.current)?.name;
  ...
  reactExports.useEffect(() => {
    refresh();
    const interval = setInterval(() => {
      const nextPath = localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$4) || "";
      if (nextPath && nextPath !== activeProjectPath) {
        refresh();
      }
    }, 1e3);
  ...
  const handleCreateBranch = async () => {
    ...
    if (branches.some((b2) => b2.name === newBranchName)) {
  ...
  const handleDeleteBranch = async (branchName, isProtected, isCurrent) => {
    if (isProtected) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    showGuide && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2 border-green-500 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950/30 dark:to-green-900/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-green-900 dark:text-green-100 flex items-center gap-2", children: "🌿 브랜치가 뭐예요?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: "ghost",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4 text-green-900 dark:text-green-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card/60 p-4 rounded-lg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-2", children: "🎮 게임으로 이해하기:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "RPG 게임에서 여러 세이브 파일을 만드는 것과 같아요! 메인 스토리(main 브랜치)는 안전하게 두고, 새로운 시도(feature 브랜치)는 별도로 진행할 수 있어요." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "브랜치를 사용하는 이유:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "✅ ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "안전하게 실험:" }),
              " 메인 코드를 망가뜨릴 걱정 없이 새 기능 개발"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "✅ ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "동시 작업:" }),
              " 여러 기능을 동시에 개발 가능"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "✅ ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "쉬운 롤백:" }),
              " 실패하면 브랜치만 삭제하면 돼요"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "✅ ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "팀 협업:" }),
              " 각자 자기 브랜치에서 작업 후 합치기"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-amber-100 p-3 rounded-lg border border-amber-300 dark:bg-amber-950/30 dark:border-amber-900", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-amber-900 dark:text-amber-100", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "📌 기억하세요:" }),
          " main 브랜치는 항상 작동하는 안정적인 코드를 유지하고, 새로운 작업은 별도 브랜치에서 하세요!"
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-2 border-blue-500 bg-blue-50 dark:bg-blue-950/30 dark:border-blue-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-blue-500 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GitBranch, { className: "w-6 h-6 text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-blue-900 dark:text-blue-100", children: "현재 브랜치" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-blue-700 font-semibold text-lg", children: activeProjectName ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            currentBranch?.name || "-",
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-sm font-normal text-blue-700/80", children: [
              "(",
              activeProjectName,
              ")"
            ] })
          ] }) : currentBranch?.name }),
          activeProjectPath ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-blue-800/70 mt-1", children: activeProjectPath }) : null
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        currentBranch?.isProtected && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-yellow-100 text-yellow-800 border-yellow-300", children: "보호됨" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "sm", onClick: refresh, disabled: busy, children: "새로고침" })
      ] })
    ] }) }) }),
    !showCreateBranch && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
    ...
    showCreateBranch && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2 border-green-500 shadow-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "bg-green-50 dark:bg-green-950/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "새 브랜치 만들기" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-base", children: "새로운 작업을 위한 독립적인 공간을 만들어요" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-6 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-blue-50 border-blue-200 dark:bg-blue-950/20 dark:border-blue-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "💡" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-blue-900 dark:text-blue-100", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-1", children: "브랜치란?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "메인 코드에 영향을 주지 않고 새로운 기능을 개발할 수 있는 별도의 작업 공간이에요!" })
          ] })
        ] }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-base font-semibold", children: "브랜치 이름" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "어떤 작업을 할지 알 수 있는 이름을 지어주세요" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-base font-semibold", children: "어느 브랜치에서 시작할까요?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              ...
              children: branches.map((branch) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: branch.name, children: branch.name }, branch.id))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "보통 main 브랜치에서 시작해요" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleCreateBranch, className: "flex-1", size: "lg", disabled: busy, children: "브랜치 만들기" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "outline",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "모든 브랜치" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardDescription, { children: [
          branches.length,
          "개의 브랜치"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-3", children: !activeProjectPath ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(GitBranch, { className: "w-16 h-16 mx-auto mb-4 opacity-50" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "현재 프로젝트가 선택되지 않았어요" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-2", children: '"프로젝트" 탭에서 Clone 후 상태 버튼을 눌러 선택해주세요.' })
      ] }) : branches.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(GitBranch, { className: "w-16 h-16 mx-auto mb-4 opacity-50" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "브랜치를 불러오지 못했거나, 브랜치가 없습니다" })
      ] }) : branches.map((branch) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: `p-4 rounded-lg border transition-all ${branch.current ? "bg-blue-50 border-blue-300 shadow-sm dark:bg-blue-950/30 dark:border-blue-900" : "bg-card border-border hover:border-border/80"}`,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-between gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(GitBranch, { className: `w-5 h-5 ${branch.current ? "text-blue-600" : "text-muted-foreground"}` }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold font-mono", children: branch.name }),
                  branch.current && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-blue-600", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3 h-3 mr-1" }),
                    "현재"
                  ] }),
                  branch.isProtected && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "bg-yellow-50 text-yellow-700 border-yellow-300", children: "보호됨" })
                ] }),
            ...
            !branch.current && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pl-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  size: "sm",
...
const Textarea = reactExports.forwardRef(
  ({ className, ...props }, ref) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        className: cn$2(
          "flex min-h-[60px] w-full rounded-md border border-input bg-input-background px-3 py-2 text-sm shadow-sm transition-[color,box-shadow] placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
          className
        ),
        ref,
        ...props
...
const ACTIVE_PROJECT_PATH_KEY$3 = "activeProjectPath";
...
function FileChanges() {
  ...
  const [commitDescription, setCommitDescription] = reactExports.useState("");
  const [showExplanation, setShowExplanation] = reactExports.useState(true);
  const [activeProjectPath, setActiveProjectPath] = reactExports.useState(() => localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$3) || "");
  const [activeProjectName, setActiveProjectName] = reactExports.useState(() => localStorage.getItem(ACTIVE_PROJECT_NAME_KEY) || "");
  const [busy, setBusy] = reactExports.useState(false);
  const [selectedDiffFile, setSelectedDiffFile] = reactExports.useState("");
  ...
  const refresh = async () => {
    ...
    const repoPath = localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$3) || "";
    ...
    try {
      ...
      const normalized = rawChanges.map((c) => ({
        id: c.path,
        path: c.path,
        type: c.type,
  ...
  reactExports.useEffect(() => {
    refresh();
    const interval = setInterval(() => {
      const nextPath = localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$3) || "";
      if (nextPath && nextPath !== activeProjectPath) {
        refresh();
      }
    }, 1e3);
  ...
  const toggleFileSelection = (id2) => {
    setChanges(changes.map(
      (change) => change.id === id2 ? { ...change, selected: !change.selected } : change
    ));
  };
  ...
  const handleCommit = async () => {
    ...
    setBusy(true);
    try {
      const filesToStage = selectedFiles.map((f2) => f2.path);
...
${commitDescription.trim()}` : commitMessage.trim();
  ...
  const getFileIcon = (type) => {
    switch (type) {
      case "added":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(FilePlus, { className: "w-4 h-4 text-green-600" });
      case "deleted":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(FileX, { className: "w-4 h-4 text-red-600" });
      case "modified":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(FilePen, { className: "w-4 h-4 text-blue-600" });
      case "untracked":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(FilePlus, { className: "w-4 h-4 text-muted-foreground" });
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-4 h-4 text-muted-foreground" });
    }
  };
  const getTypeBadge = (type) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: variants[type], children: labels[type] });
  };
  const selectedCount = reactExports.useMemo(() => changes.filter((c) => c.selected).length, [changes]);
  const totalAdditions = reactExports.useMemo(
    () => changes.filter((c) => c.selected).reduce((sum, c) => sum + c.additions, 0),
    [changes]
  );
  const totalDeletions = reactExports.useMemo(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-4", children: [
      showExplanation && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2 border-blue-500 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/30 dark:to-blue-900/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-blue-900 dark:text-blue-100 flex items-center gap-2", children: "📚 변경사항 탭이란?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "ghost",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3 text-blue-900 dark:text-blue-100", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "이곳에서 무엇을 하나요?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: "1️⃣" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "파일 확인:" }),
                " 어떤 파일을 수정했는지 확인해요"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: "2️⃣" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "변경사항 선택:" }),
                " 저장하고 싶은 파일을 선택해요"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: "3️⃣" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "커밋 메시지 작성:" }),
                " 무엇을 바꿨는지 메모해요"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: "4️⃣" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "커밋하기:" }),
                " 변경사항을 역사에 기록해요!"
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card/60 p-3 rounded-lg mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", children: [
            "💡 ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "비유하자면:" }),
            " 게임을 저장하는 것처럼, 코드 작업을 저장하는 거예요. 나중에 문제가 생기면 이전 저장 지점으로 돌아갈 수 있어요!"
          ] }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "변경된 파일" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardDescription, { children: [
              activeProjectName ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "현재 프로젝트: ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: activeProjectName })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "sm", onClick: refresh, disabled: busy, children: "새로고침" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "sm", onClick: toggleAllFiles, disabled: busy, children: changes.length > 0 && changes.every((c) => c.selected) ? "전체 해제" : "전체 선택" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-2", children: !activeProjectPath ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-16 h-16 mx-auto mb-4 opacity-50" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "현재 프로젝트가 선택되지 않았어요" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-2", children: '"프로젝트" 탭에서 Clone 후 상태 버튼을 눌러 선택해주세요.' })
        ] }) : changes.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-16 h-16 mx-auto mb-4 opacity-50" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "변경된 파일이 없습니다" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-2", children: "모든 변경사항이 커밋되었습니다" })
        ] }) : changes.map((change) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `flex items-center gap-3 p-3 rounded-lg border transition-colors ${change.selected ? "bg-blue-50 border-blue-200 dark:bg-blue-950/30 dark:border-blue-900" : "bg-card border-border"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Checkbox,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex items-center gap-3", children: [
                getFileIcon(change.type),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-sm font-medium", children: change.path }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
                    getTypeBadge(change.type),
                    change.staged && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "bg-green-50 text-green-700 border-green-300", children: "스테이징됨" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-green-600", children: [
                      "+",
                      change.additions
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-red-600", children: [
                      "-",
                      change.deletions
                    ] })
                  ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "변경 내용 미리보기" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "선택한 파일의 변경사항" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "bg-purple-50 text-purple-700", children: "읽는 방법 👇" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-amber-50 border-amber-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm text-amber-900", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-2", children: "🔍 Diff 읽는 법:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 bg-red-300 rounded" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "빨간색:" }),
                  " 삭제된 코드 (- 기호)"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 bg-green-300 rounded" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "초록색:" }),
                  " 추가된 코드 (+ 기호)"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 bg-border rounded" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "회색:" }),
                  " 변경되지 않은 코드"
                ] })
              ] })
            ] })
          ] }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-slate-900 text-slate-100 p-4 rounded-lg font-mono text-sm max-h-96 overflow-y-auto", children: !selectedDiffFile ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground/70", children: "오른쪽 목록에서 파일 아이콘(문서 버튼)을 눌러 변경 내용을 확인하세요." }) : diffText ? /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "whitespace-pre-wrap break-words", children: diffText }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground/70", children: "선택한 파일의 diff를 불러오지 못했습니다." }) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "커밋 정보" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "선택한 파일을 커밋합니다" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 dark:from-blue-950/20 dark:to-blue-900/10 dark:border-blue-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-blue-600", children: selectedCount }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "선택한 파일" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "추가된 줄" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "삭제된 줄" })
          ] })
        ] }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm", children: "💡 커밋 메시지 팁" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "text-xs text-muted-foreground space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: '• 현재형으로 작성하세요 (예: "Add" not "Added")' }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "• 50자 이내로 간결하게" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "• 무엇을, 왜 변경했는지 설명" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "• 이슈 번호 참조 (#123)" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-red-50 border-red-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm text-red-900", children: "⚠️ 초보자가 자주 하는 실수" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "text-xs text-red-800 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "• ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "커밋 메시지를 대충 쓰기:" }),
              ' "수정", "변경" 같은 메시지는 나중에 혼란스러워요'
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "• ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "너무 많은 변경사항을 한 번에:" }),
              " 작은 단위로 자주 커밋하는 게 좋아요"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "• ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "테스트 안 된 코드 커밋:" }),
              " 작동하는 코드만 커밋하세요"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "• ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "커밋 전에 Pull 안 하기:" }),
              " 작업 전 항상 최신 코드를 받아오세요"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-semibold", children: "커밋 메시지 (무엇을 바꿨나요?) *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-semibold", children: "상세 설명 (선택사항)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(GitCommitHorizontal, { className: "w-5 h-5 mr-2" }),
                "변경사항 저장 (Commit)"
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-center text-muted-foreground", children: "커밋하면 작업 내용이 기록됩니다" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              onClick: handlePush,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-center text-muted-foreground", children: "GitHub 서버에 코드를 올립니다" })
        ] })
      ] })
    ] }) })
  ] });
...
const ACTIVE_PROJECT_PATH_KEY$2 = "activeProjectPath";
function parseOwnerRepoFromRemoteUrl$2(remoteUrl) {
...
function PullRequestManager() {
  ...
  const [activeTab, setActiveTab] = reactExports.useState("open");
  const [showGuide, setShowGuide] = reactExports.useState(true);
  const [activeProjectPath, setActiveProjectPath] = reactExports.useState(() => localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$2) || "");
  const [repoOwner, setRepoOwner] = reactExports.useState("");
  const [repoName, setRepoName] = reactExports.useState("");
  const [busy, setBusy] = reactExports.useState(false);
  const [createOpen, setCreateOpen] = reactExports.useState(false);
  const [newPrTitle, setNewPrTitle] = reactExports.useState("");
  const [newPrBody, setNewPrBody] = reactExports.useState("");
  const [newPrBase, setNewPrBase] = reactExports.useState("main");
  const [newPrHead, setNewPrHead] = reactExports.useState("");
  const refresh = async () => {
    if (!window.easyGithub) {
      toast.error("Electron 환경에서만 PR 관리를 지원합니다");
      return;
    }
    const repoPath = localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$2) || "";
    setActiveProjectPath(repoPath);
    if (!repoPath) {
      setPrs([]);
      return;
    ...
    try {
      ...
      const parsed = originUrl ? parseOwnerRepoFromRemoteUrl$2(originUrl) : null;
      if (!parsed) {
      ...
      const list = raw.map((pr) => {
        ...
        const status = isMerged ? "merged" : pr.state === "closed" ? "closed" : "open";
        return {
          id: String(pr.id),
          number: pr.number,
          title: pr.title,
          ...
          authorInitials: getInitials$1(pr.user?.login || "Unknown"),
          status,
          ...
          labels: (pr.labels || []).map((l2) => l2.name).filter(Boolean)
        };
      });
      setPrs(list);
    } catch (err) {
  ...
  reactExports.useEffect(() => {
    refresh();
    const interval = setInterval(() => {
      const nextPath = localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$2) || "";
      if (nextPath && nextPath !== activeProjectPath) {
        refresh();
      }
    }, 1e3);
  ...
  const filteredPRs = reactExports.useMemo(() => prs.filter((pr) => pr.status === activeTab), [prs, activeTab]);
  const getStatusIcon = (status) => {
    switch (status) {
      case "open":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(GitPullRequest, { className: "w-5 h-5 text-green-600" });
      case "merged":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(GitMerge, { className: "w-5 h-5 text-purple-600" });
      case "closed":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "w-5 h-5 text-red-600" });
    }
  };
  const getStatusBadge = (status) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: variants[status], children: labels[status] });
  };
  ...
  const handleApprove = async (pullNumber) => {
    if (!window.easyGithub) return;
  ...
  const handleMerge = async (pullNumber) => {
    if (!window.easyGithub) return;
    if (!repoOwner || !repoName) {
      toast.error("저장소 정보를 확인할 수 없습니다");
      return;
  ...
  const [commentTarget, setCommentTarget] = reactExports.useState(null);
  const [commentBody, setCommentBody] = reactExports.useState("");
  const openComment = (prNumber, title) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    showGuide && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2 border-purple-500 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/30 dark:to-purple-900/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-purple-900 dark:text-purple-100 flex items-center gap-2", children: "🤝 Pull Request가 뭐예요?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: "ghost",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4 text-purple-900 dark:text-purple-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card/60 p-4 rounded-lg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-2", children: "📝 쉽게 말하면:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: '"내가 작업한 코드를 확인해주세요! 괜찮으면 메인 코드에 합쳐주세요!" 라고 요청하는 거예요.' })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "Pull Request 과정:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-blue-100 text-blue-800", children: "1. 코드 작성" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "→" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-green-100 text-green-800", children: "2. PR 생성" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "→" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-purple-100 text-purple-800", children: "3. 팀원 리뷰" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "→" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-orange-100 text-orange-800", children: "4. 승인" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "→" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-pink-100 text-pink-800", children: "5. 병합 완료!" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "왜 필요한가요?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "✅ ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "코드 리뷰:" }),
            " 다른 사람이 내 코드를 검토해요"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "✅ ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "버그 방지:" }),
            " 문제를 미리 발견할 수 있어요"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "✅ ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "지식 공유:" }),
            " 팀원들이 변경사항을 알 수 있어요"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "✅ ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "품질 관리:" }),
            " 코드 품질을 높게 유지해요"
          ] })
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Open" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-green-600 mt-1", children: openCount })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(GitPullRequest, { className: "w-10 h-10 text-green-500" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Merged" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-purple-600 mt-1", children: mergedCount })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(GitMerge, { className: "w-10 h-10 text-purple-500" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Closed" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-red-600 mt-1", children: closedCount })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "w-10 h-10 text-red-500" })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: commentOpen, onOpenChange: setCommentOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "PR 코멘트 달기" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: commentTarget ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          "#",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "코멘트" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Textarea,
          {
            value: commentBody,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setCommentOpen(false), disabled: busy, children: "취소" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: submitComment, disabled: busy || !commentTarget, children: "등록" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: activeProjectPath ? repoOwner && repoName ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "현재 저장소: ",
          ...
          ] }) : "현재 저장소를 확인 중입니다" : "현재 프로젝트가 선택되지 않았습니다" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open: createOpen, onOpenChange: setCreateOpen, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", disabled: busy || !activeProjectPath || !repoOwner || !repoName, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4 mr-2" }),
              "새 PR"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Pull Request 만들기" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogDescription, { children: [
                  "초보자 팁: 보통 ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "내 작업 브랜치" }),
                  "에서 ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "main" }),
                  "으로 PR을 만들어요."
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "제목 *" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: newPrTitle, onChange: (e) => setNewPrTitle(e.target.value), placeholder: "예: 로그인 기능 추가" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "설명" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { value: newPrBody, onChange: (e) => setNewPrBody(e.target.value), rows: 4, placeholder: "무엇을/왜 변경했는지 적어주세요" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "내 브랜치(head)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: newPrHead, onChange: (e) => setNewPrHead(e.target.value), placeholder: "예: feature/login" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "대상 브랜치(base)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: newPrBase, onChange: (e) => setNewPrBase(e.target.value), placeholder: "예: main" })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: refresh, disabled: busy, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "w-4 h-4 mr-2" }),
            "새로고침"
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: !activeProjectPath ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(GitPullRequest, { className: "w-16 h-16 mx-auto mb-4 opacity-50" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "현재 프로젝트가 선택되지 않았어요" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-2", children: '"프로젝트" 탭에서 Clone 후 상태 버튼을 눌러 선택해주세요.' })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "grid w-full grid-cols-3 mb-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "merged", children: [
            "Merged (",
            mergedCount,
            ")"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "closed", children: [
            "Closed (",
            closedCount,
            ")"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: activeTab, className: "space-y-4", children: filteredPRs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GitPullRequest, { className: "w-16 h-16 mx-auto mb-4 opacity-50" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Pull Request가 없습니다" })
        ] }) : filteredPRs.map((pr) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "hover:shadow-md transition-shadow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: getStatusIcon(pr.status) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-lg", children: pr.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                    "#",
                    pr.number
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: pr.description })
              ] }),
              getStatusBadge(pr.status)
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "font-mono", children: pr.sourceBranch }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/70", children: "→" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "font-mono", children: pr.targetBranch })
            ] }),
            pr.labels.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: pr.labels.map((label) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-sm text-muted-foreground pt-2 border-t", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-5 h-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "text-xs", children: pr.authorInitials }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: pr.author })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: pr.created })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "w-4 h-4" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: pr.comments })
              ] }),
              pr.approvals > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-green-600", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: pr.approvals })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-2", children: [
              pr.status === "open" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "default", onClick: () => handleApprove(pr.number), disabled: busy, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", onClick: () => handleMerge(pr.number), disabled: busy, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(GitMerge, { className: "w-4 h-4 mr-2" }),
                  "Merge"
                ] })
              ] }),
...
const ACTIVE_PROJECT_PATH_KEY$1 = "activeProjectPath";
function parseOwnerRepoFromRemoteUrl$1(remoteUrl) {
  const trimmed = remoteUrl.trim();
  if (!trimmed) return null;
  const withoutGit = trimmed.endsWith(".git") ? trimmed.slice(0, -4) : trimmed;
  const sshMatch = withoutGit.match(/^git@github\.com:(.+?)\/(.+)$/);
...
function IssueTracker() {
  ...
  const [activeTab, setActiveTab] = reactExports.useState("open");
  const [showCreateIssue, setShowCreateIssue] = reactExports.useState(false);
  const [newIssueTitle, setNewIssueTitle] = reactExports.useState("");
  const [newIssueDescription, setNewIssueDescription] = reactExports.useState("");
  const [showGuide, setShowGuide] = reactExports.useState(true);
  const [activeProjectPath, setActiveProjectPath] = reactExports.useState(() => localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$1) || "");
  const [repoOwner, setRepoOwner] = reactExports.useState("");
  const [repoName, setRepoName] = reactExports.useState("");
  const [busy, setBusy] = reactExports.useState(false);
  const [commentOpen, setCommentOpen] = reactExports.useState(false);
  ...
  const refresh = async () => {
    ...
    const repoPath = localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$1) || "";
    setActiveProjectPath(repoPath);
    if (!repoPath) {
      setIssues([]);
      return;
    ...
    try {
      const originUrl = await window.easyGithub.git.originUrl(repoPath);
      const parsed = originUrl ? parseOwnerRepoFromRemoteUrl$1(originUrl) : null;
      if (!parsed) {
        toast.error("원격(origin) URL에서 GitHub 저장소를 확인할 수 없습니다");
        setIssues([]);
        return;
      ...
      const list = raw.map((issue) => {
        const labels = (issue.labels || []).map((l2) => l2.name).filter(Boolean);
        ...
        return {
          ...
          assigneeInitials: issue.assignee?.login ? getInitials(issue.assignee.login) : void 0,
  ...
  reactExports.useEffect(() => {
    refresh();
    const interval = setInterval(() => {
      const nextPath = localStorage.getItem(ACTIVE_PROJECT_PATH_KEY$1) || "";
      if (nextPath && nextPath !== activeProjectPath) {
        refresh();
      }
    }, 1e3);
  ...
  const filteredIssues = reactExports.useMemo(() => issues.filter((issue) => issue.status === activeTab), [issues, activeTab]);
  ...
  const openComment = (issueNumber, title) => {
  ...
  const getTypeIcon = (type) => {
    switch (type) {
      case "bug":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Bug, { className: "w-5 h-5 text-red-600" });
      case "enhancement":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-5 h-5 text-blue-600" });
      case "question":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "w-5 h-5 text-purple-600" });
    }
  };
  const getTypeBadge = (type) => {
    const variants = {
  ...
  const getPriorityBadge = (priority) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: variants[priority], children: labels[priority] });
  };
  const getLabelColor = (label) => {
    const colors = {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: commentOpen, onOpenChange: setCommentOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "이슈 코멘트 달기" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: commentTarget ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          "#",
          commentTarget.number,
          " · ",
    ...
    showGuide && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2 border-orange-500 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950/30 dark:to-orange-900/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-orange-900 dark:text-orange-100 flex items-center gap-2", children: "🐛 이슈(Issue)란?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: "ghost",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4 text-orange-900 dark:text-orange-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card/60 p-4 rounded-lg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-2", children: "📋 할 일 목록이에요!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "버그, 새로운 기능 아이디어, 질문 등을 기록하고 관리하는 곳이에요. 팀 프로젝트의 할 일 목록(To-Do List)이라고 생각하면 돼요!" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "이슈의 종류:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "🐛 ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Bug:" }),
              " 프로그램이 제대로 작동하지 않을 때"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "✨ ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Enhancement:" }),
              " 새로운 기능이나 개선 아이디어"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "❓ ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "이슈를 언제 만드나요?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "• 버그를 발견했을 때" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "• 새로운 기능이 필요할 때" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "• 코드를 개선하고 싶을 때" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "• 팀원에게 질문할 게 있을 때" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-blue-100 p-3 rounded-lg border border-blue-300 dark:bg-blue-950/30 dark:border-blue-900", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-blue-900 dark:text-blue-100", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "💡 팁:" }),
          ' 이슈를 만들 때는 구체적으로 작성하세요! "버튼이 안 돼요" 보다는 "로그인 버튼 클릭 시 404 에러 발생"이 훨씬 좋아요.'
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-10 h-10 text-green-500" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Closed" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-purple-600 mt-1", children: closedCount })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-10 h-10 text-purple-500" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Bugs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-red-600 mt-1", children: issues.filter((i) => i.type === "bug" && i.status === "open").length })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bug, { className: "w-10 h-10 text-red-500" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "High Priority" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-orange-600 mt-1", children: issues.filter((i) => i.priority === "high" && i.status === "open").length })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-10 h-10 text-orange-500" })
      ] }) }) })
    ] }),
    !showCreateIssue && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
    ...
    showCreateIssue && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2 border-blue-500", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "새 이슈 만들기" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "버그 리포트, 기능 요청, 질문 등을 작성하세요" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "제목 *" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleCreateIssue, className: "flex-1", children: "생성" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "outline",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "이슈" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: activeProjectPath ? repoOwner && repoName ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "현재 저장소: ",
            /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { children: [
              repoOwner,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: !activeProjectPath ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-16 h-16 mx-auto mb-4 opacity-50" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "현재 프로젝트가 선택되지 않았어요" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-2", children: '"프로젝트" 탭에서 Clone 후 상태 버튼을 눌러 선택해주세요.' })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: (v2) => setActiveTab(v2), children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: activeTab, className: "space-y-4", children: filteredIssues.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-16 h-16 mx-auto mb-4 opacity-50" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "이슈가 없습니다" })
        ] }) : filteredIssues.map((issue) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "hover:shadow-md transition-shadow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: getTypeIcon(issue.type) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold", children: issue.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground text-sm", children: [
                    "#",
                    issue.number
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: issue.description })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            ...
            issue.labels.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: issue.labels.map((label) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                className: getLabelColor(label),
                children: label
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-sm text-muted-foreground pt-2 border-t", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-5 h-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "text-xs", children: issue.authorInitials }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: issue.author })
              ] }),
              issue.assignee && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/70", children: "assigned to" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-5 h-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "text-xs", children: issue.assigneeInitials }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: issue.assignee })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "•" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: issue.created }),
              issue.comments > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "•" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "w-4 h-4" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: issue.comments })
                ] })
              ] })
            ] }),
            issue.status === "open" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  size: "sm",
...
const guideSteps = [
  {
    id: 1,
    title: "프로젝트 시작하기",
    description: "먼저 GitHub에서 프로젝트를 다운로드(Clone)하거나, 새로운 프로젝트를 만들어요.",
    icon: FolderGit2,
    tips: [
      "Clone은 '복사'라고 생각하면 쉬워요!",
      "GitHub에서 코드 주소(URL)를 복사하세요",
      "컴퓨터에 저장할 폴더를 선택하세요"
    ]
  },
  {
    id: 2,
    title: "파일 수정하고 저장하기",
    description: "코드를 수정한 후, 변경사항을 '커밋(Commit)'으로 저장해요.",
    icon: GitCommitHorizontal,
    tips: [
      "커밋은 '저장'이라고 생각하면 돼요",
      "커밋 메시지는 '무엇을 바꿨는지' 적어요",
      "예: '로그인 버튼 색상 변경'처럼 구체적으로!"
    ]
  },
  {
    id: 3,
    title: "GitHub에 업로드하기",
    description: "내 작업을 GitHub에 올려서(Push) 다른 사람과 공유해요.",
    icon: Upload,
    tips: [
      "Push는 '업로드'예요",
      "커밋한 내용을 GitHub 서버에 보내요",
      "팀원들이 내 작업을 볼 수 있어요!"
    ]
  },
  {
    id: 4,
    title: "최신 코드 받아오기",
    description: "다른 사람이 올린 최신 코드를 받아와요(Pull).",
    icon: Download,
    tips: [
      "Pull은 '다운로드'예요",
      "팀원의 작업을 내 컴퓨터로 가져와요",
      "작업 전에 항상 Pull 하는 습관을 들이세요!"
    ]
  },
  {
    id: 5,
    title: "브랜치로 안전하게 작업하기",
    description: "새로운 기능은 별도의 '브랜치'에서 만들어요.",
    icon: GitBranch,
    tips: [
      "브랜치는 '작업 공간'이라고 생각하세요",
      "실험적인 작업도 안전하게 할 수 있어요",
      "완성되면 메인 브랜치에 합쳐요(Merge)"
    ]
  }
];
function BeginnerGuide({ onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "w-full max-w-3xl max-h-[90vh] overflow-y-auto shadow-2xl border-2 border-blue-500", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "bg-gradient-to-r from-blue-600 to-blue-700 text-white", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white/20 p-2 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-6 h-6" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-2xl", children: "초보자 가이드" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "진행률" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            currentStep + 1,
            " / ",
            guideSteps.length
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-8 pb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: guideSteps.map((s, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold transition-all ${idx === currentStep ? "bg-blue-600 text-white scale-110" : completedSteps.has(s.id) ? "bg-green-500 text-white" : "bg-border text-muted-foreground"}`,
            children: completedSteps.has(s.id) ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-5 h-5" }) : idx + 1
          }
        ),
        idx < guideSteps.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-1 bg-border mx-1" })
      ] }, s.id)) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-blue-100 p-6 rounded-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-16 h-16 text-blue-600" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "mb-3 text-sm", children: [
              "Step ",
              step.id
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-foreground", children: step.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground mt-3 leading-relaxed", children: step.description })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-yellow-50 border-yellow-200", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { className: "w-5 h-5 text-yellow-600 flex-shrink-0 mt-1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-yellow-900", children: "알아두면 좋아요!" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 ml-8", children: step.tips.map((tip, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "text-sm text-yellow-800 flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-600 mt-1", children: "•" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: tip })
          ] }, idx)) })
        ] }) }),
        currentStep === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-semibold", children: "예시:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-slate-900 text-green-400 p-4 rounded-lg font-mono text-sm", children: "$ git clone https://github.com/username/my-project.git" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "↑ 이 명령어로 프로젝트를 다운로드해요" })
        ] }) }) }),
        currentStep === 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-semibold text-center", children: "작업 순서:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-sm", children: "1. 파일 수정" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4 text-muted-foreground/70" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-sm", children: "2. git add" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4 text-muted-foreground/70" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-sm", children: "3. git commit" })
          ] })
        ] }) }) }),
        currentStep === 4 && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-semibold", children: "브랜치 이름 예시:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 justify-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-blue-100 text-blue-800", children: "feature/login" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-green-100 text-green-800", children: "feature/signup" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-red-100 text-red-800", children: "bugfix/error" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-purple-100 text-purple-800", children: "hotfix/security" })
          ] })
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-8 pt-6 border-t", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: "outline",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: currentStep === guideSteps.length - 1 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleComplete, size: "lg", className: "gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-5 h-5" }),
          "완료하고 시작하기"
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleNextStep, size: "lg", className: "gap-2", children: [
          "다음",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-5 h-5" })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "mt-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-5 h-5 flex-shrink-0 mt-1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold mb-2", children: "바로 시작하고 싶다면?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-blue-100", children: `'프로젝트' 탭에서 "프로젝트 추가 / Clone" 버튼을 눌러 시작하세요!` })
        ] })
      ] }) }) })
    ] })
  ] }) });
...
function GitHubManager() {
  ...
  const [themeMounted, setThemeMounted] = reactExports.useState(false);
  ...
  const [tokenDialogOpen, setTokenDialogOpen] = reactExports.useState(false);
  const [tokenInput, setTokenInput] = reactExports.useState("");
  const lastCountsRef = reactExports.useRef({ initialized: false, prOpen: 0, issueOpen: 0 });
  ...
  reactExports.useEffect(() => {
    ...
    const pollNotifications = async () => {
      ...
      try {
        ...
        const openPrCount = prList.filter((pr) => pr.state === "open").length;
    ...
    pollNotifications();
    const interval = setInterval(pollNotifications, 12e4);
    return () => {
      cancelled = true;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-background to-muted", children: [
    showGuide && /* @__PURE__ */ jsxRuntimeExports.jsx(BeginnerGuide, { onClose: handleCloseGuide }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Dialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "GitHub 토큰으로 로그인" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "토큰은 PC 안에서만 암호화 저장되며, 브라우저 로그인을 사용하지 않습니다." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              "필요 권한 예시: private repo 사용 시 ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "px-1", children: "repo" }),
              ", 공개 repo만이면 최소 권한으로도 동작합니다."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full flex-col gap-2 sm:flex-row sm:justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 sm:justify-end", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "outline", onClick: () => setTokenDialogOpen(false), disabled: authBusy, children: "취소" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-950 dark:to-blue-900 text-white shadow-lg border-b border-blue-800 dark:border-blue-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-6 py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white/20 p-3 rounded-xl backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FolderGit2, { className: "w-7 h-7" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold", children: "GitHub 프로젝트 관리자" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-100 text-sm", children: "쉽고 간단하게 코드를 관리하세요 ✨" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex items-center gap-2 bg-white/10 border border-white/20 rounded-md px-3 py-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-4 h-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: authenticated ? authUser?.login ?? "로그인됨" : "로그인 안됨" })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeIcon, { className: "w-4 h-4 mr-2" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "container mx-auto px-6 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, className: "w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "grid w-full grid-cols-6 mb-6 bg-card shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "overview", className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "프로젝트" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "changes", className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-4 h-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "변경사항" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "commits", className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GitCommitHorizontal, { className: "w-4 h-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "커밋" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "branches", className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GitBranch, { className: "w-4 h-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "브랜치" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "pulls", className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GitPullRequest, { className: "w-4 h-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "리뷰" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "issues", className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bug, { className: "w-4 h-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "이슈" })
        ] })
      ] }),
      showHelp && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "mb-6 border-2 border-blue-500 bg-blue-50 dark:border-blue-900 dark:bg-blue-950/30", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-blue-900 dark:text-blue-100 flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-blue-800 dark:text-blue-200 leading-relaxed", children: [
          "💡 ",
          tabHelpText[activeTab]
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "overview", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectOverview, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "changes", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileChanges, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "commits", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CommitHistory, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "branches", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BranchManager, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "pulls", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PullRequestManager, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "issues", children: /* @__PURE__ */ jsxRuntimeExports.jsx(IssueTracker, {}) })
    ] }) })
  ] });
}
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(J, { attribute: "class", defaultTheme: "system", enableSystem: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(GitHubManager, {}),
